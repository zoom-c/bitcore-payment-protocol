...
PaymentProtocol.PAYMENT_REQUEST_CONTENT_TYPE = 'application/zoom-paymentrequest';
PaymentProtocol.PAYMENT_CONTENT_TYPE = 'application/zoom-payment';
PaymentProtocol.PAYMENT_ACK_CONTENT_TYPE = 'application/zoom-paymentack';
...
function magicHash(str) {
  var magicBytes = new Buffer('Zoom Signed Message:\n');
